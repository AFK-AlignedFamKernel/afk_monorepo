...
const sectors = [
  ...
  {
    sector: 'Social Media',
    problem: 'Censorship, deplatforming',
    solution: 'Nostr + zkDID + relays',
  },
  {
    sector: 'Insights & Knowledge',
    problem: 'Censorship, gatekeeping',
    solution: 'InfoFi market of Attention',
  },
  {
    sector: 'Privacy',
        ...
        >
          ...
          >
            <Heading size="2xl" mb={4}>
              Explore AFK Features
            </Heading>
            <Text fontSize="xl" color="gray.500" maxW="3xl">
              AFK is your all-in-one decentralized platform — combining social, payments, identity,
              and privacy into a seamless and sovereign experience.
            </Text>
          </MotionBox>
          ...
          <Box pt={12} w="full" textAlign="center">
            <Text rounded="full" px={10} py={6} fontSize="lg" fontWeight="bold" fontFamily="mono">
              Ready to jump in?
            </Text>
            <Link href="https://afk-community.xyz" passHref target="_blank">
              <Button
                size="lg"
                // colorScheme="b"
                rounded="full"
