    ...
    <div className="bg-black text-white">
      ...
      <div className="desktop:h-[900px] h-[833px] w-full overflow-hidden relative pt-[98px] desktop:pt-[159px] flex justify-center bg-black desktop:bg-herobg bg-mobileHeroBg bg-no-repeat bg-bottom">
        ...
        >
          ...
          <p className="desktop:text-[16px] text-base leading-8 mb-8">Open source public good app for your Ownership & Freedom. Join us in the movement.</p>
          <p className="desktop:text-[16px] text-base leading-8 mb-8">
            Welcome to Aligned Fam Kernel, a all-in-one app for you money, identity, content and privacy.
            Entirely open-sourced and community-managed, Aligned Fam Kernel empowers you to
            shape your digital life.
          </p>
        </motion.div>
        <motion.img
      ...
      <div className="mx-24 mt-12">
        ...
        <div className="mt-12 p-8">
          <h1 className="text-5xl p-5">Why Nostr, ZK, Starknet, Ethereum & Bitcoin?</h1>
          <p>ZK is a technology that allows for to proof something without sharing the overall data.</p>
          <p>Starknet is a layer 2 scaling solution for Ethereum & Bitcoin. It is a high-performance, scalable, and secure blockchain that allows for faster and cheaper transactions.</p>
          <p className="p-5 tracking-wide leading-loose">
