...
import { getTrendingAndViralByEvents } from "./nostr/content/scoring";
import { fetchEventMetadata, fetchEvents, fetchFollowers, fetchFollowings } from "./nostr/utils";
...
import { analyzeProfile } from "./nostr/profile/scoring";
...
export const initAllCronJobs = async () => {
    ...
    const handleProfilesScoring = async () => {
        console.log('Getting trending events from user pay scoring');
