...
import { handleScoringByUsersLinked, handleScoreByKeywordUserLinked } from "./nostr/cron-helpers";
...
export const initAllCronJobs = async () => {
    ...
    handleScoreByKeywordUserLinked()
    setInterval(handleScoreByKeywordUserLinked, 1000 * 60 * 60 * 24 * 7);
