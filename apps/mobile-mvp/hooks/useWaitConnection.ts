...
export const useWaitConnection = () => {
  ...
  const promise = useRef<Promise<false | UseAccountResult> | undefined>(undefined);
  const promiseResolve = useRef<((value: false | UseAccountResult) => void) | undefined>(undefined);
