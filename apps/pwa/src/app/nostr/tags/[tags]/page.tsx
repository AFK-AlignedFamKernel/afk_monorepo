...
export default function NostrTagsPageDetail() {
      ...
      <main className="max-w-7xl py-6">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div
            className="md:w-3/4"
          >
            <NostrTagsFeed searchQuery={searchQuery} 
            // tagsProps={tags as string[] || []}
            selectedTagsProps={tags as string[] || []}
             selectedTagProps={tag as string} setSelectedTagProps={() => {}} />
          </div>
