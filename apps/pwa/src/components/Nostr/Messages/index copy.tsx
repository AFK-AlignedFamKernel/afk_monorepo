...
import { useAuth, useContacts, useIncomingMessageUsers, useMyGiftWrapMessages, useMyMessagesSent, useRoomMessages } from 'afk_nostr_sdk';
...
export const NostrMessagesComponent: React.FC = () => {
  ...
  const {data: incomingMessages} = useMyMessagesSent();
  // console.log('data incoming', incomingMessages?.pages.flat());
