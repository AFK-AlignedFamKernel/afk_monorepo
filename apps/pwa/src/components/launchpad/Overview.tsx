...
export const Overview: React.FC<OverviewProps> = ({ data, isOpenLaunch }) => {
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                {data?.initial_pool_supply_dex && Number(data?.initial_pool_supply_dex) > 0 && (
                  <span>Token to sell: {Number(data?.total_supply) - Number(data?.initial_pool_supply_dex) > 0 ? Number(data?.total_supply) - Number(data?.initial_pool_supply_dex) : Number(data?.total_supply) - Number(data?.initial_pool_supply_dex)}</span>
                )}
...
export const OverviewLaunch: React.FC<OverviewProps> = ({ data, isOpenLaunch }) => {
  const { showToast } = useUIStore();
  return (
    <div className="space-y-6 shadow-lg">
      <div className="rounded-lg p-6 shadow-sm dark:bg-[var(--dark-card-bg)]">
