  ...
  filter: {
    events: [
      ...
      },
      {
        ...
        fromAddress: Deno.env.get('ART_PEACE_CONTRACT_ADDRESS'),
        keys: ['0x02838056c6784086957f2252d4a36a24d554ea2db7e09d2806cc69751d81f0a2'],
        includeReverted: false,
        includeTransaction: false,
        includeReceipt: false,
      },
      {
        ...
        fromAddress: Deno.env.get('ART_PEACE_CONTRACT_ADDRESS'),
        keys: ['0x02e4d1feaacd0627a6c7d5002564bdb4ca4877d47f00cad4714201194690a7a9'],
        includeReverted: false,
        includeTransaction: false,
        includeReceipt: false,
      },
      ...
      },
      {
        // Votable Color Event
        fromAddress: Deno.env.get('ART_PEACE_CONTRACT_ADDRESS'),
        keys: ['0x0115b3bc605487276e022f4bec68b316e7a6b3615fb01afee58241fd1d40e3e5'],
        includeReverted: false,
        includeTransaction: false,
        includeReceipt: false,
      },
      ...
      },
      {
        ...
        fromAddress: Deno.env.get('ART_PEACE_CONTRACT_ADDRESS'),
        keys: ['0x00aa4bacdfcf2717835a46fbd64f7d39bfdf2b4404bc5af8e5660415d1dc2848'],
        includeReverted: false,
        includeTransaction: false,
        includeReceipt: false,
      },
      {
        ...
        fromAddress: Deno.env.get('ART_PEACE_CONTRACT_ADDRESS'),
        keys: ['0x01e3fbdf8156ad0dde21e886d61a16d85c9ef54451eb6e253f3f427de32a47ac'],
        includeReverted: false,
        includeTransaction: false,
        includeReceipt: false,
      },
      {
        // Faction Left Event
        fromAddress: Deno.env.get('ART_PEACE_CONTRACT_ADDRESS'),
        keys: ['0x014ef8cc25c96157e2a00e9ceaa7c014a162d11d58a98871087ec488a67d7925'],
        includeReverted: false,
        includeTransaction: false,
        includeReceipt: false,
      },
      {
        ...
        fromAddress: Deno.env.get('ART_PEACE_CONTRACT_ADDRESS'),
        keys: ['0x020c994ab49a8316bcc78b06d4ff9929d83b2995af33f480b93e972cedb0c926'],
        includeReverted: false,
        includeTransaction: false,
        includeReceipt: false,
      },
      {
        ...
        fromAddress: Deno.env.get('ART_PEACE_CONTRACT_ADDRESS'),
        keys: ['0x02947960ff713d9b594a3b718b90a45360e46d1bbacef94b727bb0d461d04207'],
        includeReverted: false,
        includeTransaction: false,
        includeReceipt: false,
      },
      ...
      },
      {
        // NFT Liked Event
        fromAddress: Deno.env.get('NFT_CONTRACT_ADDRESS'),
        keys: ['0x028d7ee09447088eecdd12a86c9467a5e9ad18f819a20f9adcf6e34e0bd51453'],
        includeReverted: false,
        includeTransaction: false,
        includeReceipt: false,
      },
      {
        // NFT Unliked Event
        fromAddress: Deno.env.get('NFT_CONTRACT_ADDRESS'),
        keys: ['0x03b57514b19693484c35249c6e8b15bfe6e476205720680c2ff9f02faaf94941'],
        includeReverted: false,
        includeTransaction: false,
        includeReceipt: false,
      },
      ...
      },
      {
        ...
        fromAddress: Deno.env.get('ART_PEACE_CONTRACT_ADDRESS'),
        keys: ['0x026ab80224b4bc3543bf20cd8b66304b3591c05eac775d823e1970514881757f'],
        includeReverted: false,
        includeTransaction: false,
        includeReceipt: false,
      },
      {
        ...
        fromAddress: Deno.env.get('ART_PEACE_CONTRACT_ADDRESS'),
        keys: ['0x029a976c0074fc910f3a6a58f1351c48dab7b1c539f54ed930616292c806283f'],
        includeReverted: false,
        includeTransaction: false,
        includeReceipt: false,
      },
      {
        ...
        fromAddress: Deno.env.get('ART_PEACE_CONTRACT_ADDRESS'),
        keys: ['0x00476f35ea27024c89c1fc05dfad873e9e93419e452ee781e8207e435289a39b'],
        includeReverted: false,
        includeTransaction: false,
        includeReceipt: false,
      },
      {
        ...
        fromAddress: Deno.env.get('ART_PEACE_CONTRACT_ADDRESS'),
        keys: ['0x0126718de7cb8b83dfa258eb095bc0ec7a3ef5a2258ebd1ed349551764856c6b'],
        includeReverted: false,
        includeTransaction: false,
        includeReceipt: false,
      },
      ...
      },
      {
        ...
        fromAddress: Deno.env.get('ART_PEACE_CONTRACT_ADDRESS'),
        keys: ['0x48bbc69dde48e3d60dfee63f951ff486cb4cbc523ddd46118bee64fe6a8eae'],
        includeReverted: false,
        includeTransaction: false,
        includeReceipt: false,
      },
