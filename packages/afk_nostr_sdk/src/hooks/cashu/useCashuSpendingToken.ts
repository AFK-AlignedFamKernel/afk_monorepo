  ...
  return useMutation({
    ...
    mutationFn: async (data: {
      ...
      const {
        ...
        relayHint,
        walletName,
        isEncrypted, tags, encryptedMessage,
        relayUrl
      } = data
      ...
      /** TODO verify NIP-44 */
      event.content = v2.encrypt(JSON.stringify(amount && unit && direction ? contentProps : content), conversationKey, nonce);

      event.tags = data.tags ?? [
        ["a", `37375:${publicKey}:${walletName}`]
      ];
      //   "tags": [
      // [ "a", "37375:<pubkey>:my-wallet" ]
      // ]
