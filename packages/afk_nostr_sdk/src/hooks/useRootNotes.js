...
export const useRootNotes = (options) => {
    const { ndk } = useNostrContext();
    return useInfiniteQuery({
        initialPageParam: 0,
        queryKey: ['rootNotes', options === null || options === void 0 ? void 0 : options.authors, options === null || options === void 0 ? void 0 : options.search, ndk],
        ...
        queryFn: ({ pageParam }) => __awaiter(void 0, void 0, void 0, function* () {
            const notes = yield ndk.fetchEvents({
                kinds: [NDKKind.Text, NDKKind.ChannelMetadata],
