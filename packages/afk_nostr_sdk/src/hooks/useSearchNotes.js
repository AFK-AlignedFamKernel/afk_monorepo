...
export const useSearchNotes = (options) => {
    const { ndk } = useNostrContext();
    return useInfiniteQuery({
        initialPageParam: 0,
        queryKey: ['searchNotes', options === null || options === void 0 ? void 0 : options.authors, options === null || options === void 0 ? void 0 : options.search, options === null || options === void 0 ? void 0 : options.kinds, ndk],
        ...
        queryFn: ({ pageParam }) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const notes = yield ndk.fetchEvents({
                kinds: (_a = options === null || options === void 0 ? void 0 : options.kinds) !== null && _a !== void 0 ? _a : [NDKKind.Text],
