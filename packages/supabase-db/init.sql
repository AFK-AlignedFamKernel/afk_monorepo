...
CREATE TABLE IF NOT EXISTS content_creators (
    ...
    lud_address TEXT,
    tokens_address TEXT[],
    content_scraped JSONB[],
    content_linked JSONB[],
    links TEXT[],
    creator_token TEXT
);
...
CREATE TABLE IF NOT EXISTS creator_analytics (
    ...
    platform social_platform NOT NULL,
    mindshare_score DECIMAL,
    insight_value_score DECIMAL,
    regularity_score DECIMAL,
    clarity_score DECIMAL,
    storytelling_score DECIMAL,
    hook_conclusion_score DECIMAL,
    reputation_score DECIMAL,
    copywriting_score DECIMAL,
    ...
    socials_llm_classification JSONB[],
    socials_scores JSONB[],
