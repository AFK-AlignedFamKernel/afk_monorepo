export const kasarApi = process.env.EXPO_PUBLIC_KASAR_API || process.env.NEXT_PUBLIC_KASAR_API || "https://art-peace.kasar.io/api";
export const kasarApiKey = process.env.EXPO_PUBLIC_KASAR_API_KEY || process.env.NEXT_PUBLIC_KASAR_API_KEY || "sdklfj-32";
