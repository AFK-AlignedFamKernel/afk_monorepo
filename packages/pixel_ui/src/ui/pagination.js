...
export function PaginationView(props) {
  const hasMore = () => {
    return props.data.length >= props.stateValue.pageLength * props.stateValue.page;
  };
  ...
  return (
    <div className="PaginationContainer">
      {hasMore() && (
        <div title="More" className="Text__medium Button__primary" onClick={handleLoadmore}>
          more...
        </div>
      )}
    </div>
