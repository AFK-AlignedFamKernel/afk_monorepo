...
const NFTSelector = (props) => {
  ...
  }, [props.nftSelectionStarted, nftSelectionInitX, nftSelectionInitY, props.nftSelected]);
  ...
  }, [props.nftMintingMode, props.nftSelectionStarted, nftSelectionInitX, nftSelectionInitY]);
  ...
  return (
    <div
      ...
      style={{
        ...
        pointerEvents: 'none',
        display: nftSelectionWidth === 0 && nftSelectionHeight == 0 ? 'none' : 'block',
      }}
    ></div>
  );
};
