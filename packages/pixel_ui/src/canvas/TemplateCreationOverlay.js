...
const TemplateCreationOverlay = (props) => {
  ...
  }, [props.templateCreationSelected, props.templateCreationMode, props.width, props.height]);
  ...
  */
  ...
  return (
    ...
    >
      ...
      ></div>
      <div className="TemplateCreationOverlay__close Text__medium" onClick={closeOverlay}>
        X
      </div>
    </div>
  );
