export const NOSTR_FI_SCORING_ABI = [
  ...
  {
    "type": "struct",
    "name": "afk::interfaces::nostrfi_scoring_interfaces::ExternalContracts",
    "members": [
      {
        "name": "token_address",
        "type": "core::starknet::contract_address::ContractAddress"
      ...
      {
        "name": "fairlaunch_address",
        "type": "core::starknet::contract_address::ContractAddress"
      },
      {
        "name": "class_hash_memecoin",
        "type": "core::starknet::class_hash::ClassHash"
      },
      {
        "name": "vault_staking_class_hash",
        "type": "core::starknet::class_hash::ClassHash"
      },
      {
        "name": "dao_class_hash",
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "type": "function",
        "name": "set_external_contracts",
        "inputs": [
          {
            "name": "external_contracts",
            "type": "afk::interfaces::nostrfi_scoring_interfaces::ExternalContracts"
          }
        ],
        "outputs": [],
        "state_mutability": "external"
