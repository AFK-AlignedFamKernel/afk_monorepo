...
const PATH_TOKEN = path.resolve(
  __dirname,
  "../../onchain/cairo/target/dev/afk_MemecoinV2.contract_class.json"
);
const PATH_TOKEN_COMPILED = path.resolve(
  __dirname,
  "../../onchain/cairo/target/dev/afk_MemecoinV2.compiled_contract_class.json"
);
...
export const prepareAndConnectTokenContract = async (
  addressUser: string,
  account: Account
) => {
