...
pub mod DN404Component {
    ...
    use crate::tokens::dn404::dn404_mirror::{
        IDN404MirrorDispatcher, IDN404MirrorDispatcherTrait, NftTransferEvent,
    };
    ...
    impl DN404<
        TContractState, +HasComponent<TContractState>, +DN404HooksTrait<TContractState>,
    > of super::IDN404<ComponentState<TContractState>> {
        ...
        fn get_skip_nft(self: @ComponentState<TContractState>, owner: ContractAddress) -> bool {
            ...
            if !self.skip_nft_initialized.read(owner) {
                // TODO: skip non-accounts by default
                // return !super::is_account(owner)
                return false;
            }
            result
        }
        ...
        fn set_skip_nft(ref self: ComponentState<TContractState>, skip_nft: bool) -> bool {
            self._set_skip_nft(get_caller_address(), skip_nft);
            true
        }

        fn mirror_erc721(self: @ComponentState<TContractState>) -> ContractAddress {
            self.mirror_erc721.read()
        }

        fn implements_dn404(self: @ComponentState<TContractState>) -> bool {
            true
        }
        ...
        fn owner_of_nft(self: @ComponentState<TContractState>, id: u256) -> ContractAddress {
            self._owner_of(id)
        }

        fn owner_at_nft(self: @ComponentState<TContractState>, id: u256) -> ContractAddress {
            self._owner_at(id)
        }
        ...
        fn get_approved_nft(self: @ComponentState<TContractState>, id: u256) -> ContractAddress {
            self._get_approved(id)
        }

        fn balance_of_nft(self: @ComponentState<TContractState>, owner: ContractAddress) -> u256 {
            self._balance_of_nft(owner)
        }

        fn total_nft_supply(self: @ComponentState<TContractState>) -> u256 {
    ...
    pub impl InternalFunctions<
        TContractState, +HasComponent<TContractState>, impl Hooks: DN404HooksTrait<TContractState>,
    > of InternalFunctionsTrait<TContractState> {
        ...
        fn _set_skip_nft(
            ref self: ComponentState<TContractState>, owner: ContractAddress, state: bool,
        ) {
        ...
        fn _wrap_nft_id(
            ref self: ComponentState<TContractState>, id: u256, id_limit: u256,
        ) -> u256 {
        ...
        fn _ownership_index(self: @ComponentState<TContractState>, i: u256) -> u256 {
        ...
        fn _register_and_resolve_alias(
            ref self: ComponentState<TContractState>, ref to_data: AddressData, to: ContractAddress,
        ) -> u32 {
        ...
        fn _mint_next(ref self: ComponentState<TContractState>, to: ContractAddress, amount: u256) {
            // Basic validation
            assert(!to.is_zero(), errors::TransferToZeroAddress);
            assert(!self.mirror_erc721.read().is_zero(), errors::DNNotInitialized);
        ...
        fn _get_approved(self: @ComponentState<TContractState>, id: u256) -> ContractAddress {
        ...
        fn _balance_of_nft(self: @ComponentState<TContractState>, owner: ContractAddress) -> u256 {
            self.address_data.read(owner).owned_length.into()
        }

        fn _owner_of(self: @ComponentState<TContractState>, id: u256) -> ContractAddress {
            assert(self._exists(id), errors::TokenDoesNotExist);
            self._owner_at(id)
        }

        fn _owner_at(self: @ComponentState<TContractState>, id: u256) -> ContractAddress {
        ...
        fn _exists(self: @ComponentState<TContractState>, id: u256) -> bool {
            self._owner_at(id) != Zero::zero()
        }


        fn _total_nft_supply(self: @ComponentState<TContractState>) -> u256 {
        ...
        fn _set_owner_alias_and_owned_index(
            ref self: ComponentState<TContractState>, id: u256, alias: u32, index: u32,
        ) {
            let ownership_index = self._ownership_index(id);
        ...
        fn assert_caller_is_mirror(ref self: ComponentState<TContractState>) {
