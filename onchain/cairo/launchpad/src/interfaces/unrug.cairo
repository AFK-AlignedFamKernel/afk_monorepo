...
use afk_launchpad::types::launchpad_types::{
    ...
    LaunchParameters, EkuboLP, EkuboLaunchParameters, LiquidityType, EkuboUnrugLaunchParameters,
...
pub trait IUnrugLiquidity<TContractState> {
    ...
    fn set_address_ekubo_registry(ref self: TContractState, address_ekubo_router: ContractAddress);
