...
pub mod NostrDAOAccount {
    ...
    use super::{INostrDAOAccountDispatcher, INostrDAOAccountDispatcherTrait, ISRC6};
    #[storage]
    struct Storage {
        #[key]
        public_key: u256,
...
//         declare("NostrDAOAccount").unwrap()
//     }
...
//     fn deploy_account(class: ContractClass, public_key: u256) -> INostrDAOAccountDispatcher {
...
//         INostrDAOAccountDispatcher { contract_address }
//     }
