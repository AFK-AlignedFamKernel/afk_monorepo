...
pub mod NostrVaultEscrow {
    ...
    use afk::interfaces::nostrfi_scoring_interfaces::{
        ...
        EpochRewards, EpochRewardsDefault, INostrVaultEscrow, NostrAccountScoring,
    ...
    #[abi(embed_v0)]
    impl NostrVaultEscrowImpl of INostrVaultEscrow<ContractState> {
