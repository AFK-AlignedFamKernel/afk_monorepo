...
pub mod ContentContests {
    ...
    use afk::interfaces::content_contests_interface::{
        ...
        ExternalContracts, IContentContests, NewEpochEvent, NostrAccountScoringDefault,
    ...
    #[abi(embed_v0)]
    impl NostrFiScoringImpl of IContentContests<ContractState> {
        // Users functions
