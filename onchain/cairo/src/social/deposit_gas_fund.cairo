...
#[starknet::interface]
pub trait IDepositEscrowGasFund<TContractState> {
...
pub mod DepositEscrowGasFund {
    ...
    #[abi(embed_v0)]
    impl DepositEscrowImpl of IDepositEscrowGasFund<ContractState> {
...
mod tests {
    ...
    fn deploy_escrow(class: ContractClass) -> IDepositEscrowGasFundDispatcher {
        let mut calldata = array![];

        let (contract_address, _) = class.deploy(@calldata).unwrap();

        IDepositEscrowGasFundDispatcher { contract_address }
    }
    ...
    fn request_fixture_custom_classes(
        ...
        ContractAddress,
        IERC20Dispatcher,
        IDepositEscrowGasFundDispatcher,
    ) {
