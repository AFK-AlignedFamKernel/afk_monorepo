...
#[starknet::contract]
mod LockManager {
    use afk::launchpad::locker::errors;
    ...
    impl InternalLockerImpl of InternalLockerTrait {
        ...
        /// from the `user_locks` and `token_locks` mapping.
        /// It then iterates over the list and replaces the specified `lock_address` with the last
        /// element of the list.
